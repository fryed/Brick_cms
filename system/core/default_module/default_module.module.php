...
class [module] extends DBconnect {
	...
	public function runModule(){
		...
		$params						= "";
		$moduleArray 				= DBconnect::query("*","[module]",$params);
	...
	//module button set in [module].admin.tpl
	public function editModule(){
		...
		$params		= "WHERE id = 1";
		DBconnect::update("[module]","title",$title,$params);
		DBconnect::update("[module]","content",$content,$params);
		
		//send message to user and exit
		$_SESSION["messages"][] = "Message: [module] module updated successfully.";
